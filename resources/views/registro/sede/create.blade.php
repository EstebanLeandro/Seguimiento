...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3 style="font-weight: bold">Agregar nueva sede</h3>
			@if ($errors->any())                                                
			...
			{{-- {!!Form::open(array('url'=>'registro/sede','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}} --}}
...
<div class="row">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
            	...
            	<input type="text" name="descri_sede" class="form-control" placeholder="Descripción..."  value="{{old('descri_sede')}}">
