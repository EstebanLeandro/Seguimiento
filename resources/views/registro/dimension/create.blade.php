...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3 style="font-weight: bold">Crear nueva Dimensión</h3>
			@if ($errors->any())                                                
	...
	<div class="panel panel-primary"></div>
			...
			{{-- {!!Form::open(array('url'=>'registro/dimension','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}} --}}
...
<div class="row">
	            ...
	            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
            	        ...
            	        <input type="text" name="descri_dimension" class="form-control" placeholder="Descripción...">
